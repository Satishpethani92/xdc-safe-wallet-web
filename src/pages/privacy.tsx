...
const SafePrivacyPolicy = () => (
  <SmoothScroll>
    ...
    <ol>
      ...
      <li>
        &ldquo;{'XDC Safe'}&rdquo; refers to a web-based graphical user interface for Safe Accounts as well as a mobile
    ...
    <h4>4.1. When visiting our website and using {'XDC Safe'}</h4>
    <p>
      When visiting our website or using {'XDC Safe'}, we may collect and process personal data. The data will be stored
    ...
    <p>
      In addition, we may take a recording of you while testing {'XDC Safe'} for internal and external use. The basis
    ...
    <p>
      {'XDC Safe'} mobile apps are distributed via{' '}
    ...
    <p>
      We enable the user to unlock the {'XDC Safe'} mobile app via biometrics information (touch ID or face ID). This is
    ...
    <p>
      ...
      different decentralized applications and our app and to enhance your experience with {`XDC Safe`}. For enhanced
