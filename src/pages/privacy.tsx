...
const SafePrivacyPolicy = () => (
  <SmoothScroll>
    ...
    <ol>
      ...
      <li>
        &ldquo;{'XDC Safe{Wallet}'}&rdquo; refers to a web-based graphical user interface for Safe Accounts as well as a
    ...
    <h4>4.1. When visiting our website and using {'XDC Safe{Wallet}'}</h4>
    <p>
      When visiting our website or using {'XDC Safe{Wallet}'}, we may collect and process personal data. The data will
    ...
    <ol start={4}>
      <li>
        ...
        the {'XDC Safe{Wallet}'}, we process your
        <ol>
    ...
    <p>
      In addition, we may take a recording of you while testing {'XDC Safe{Wallet}'} for internal and external use. The
    ...
    <p>
      {'XDC Safe{Wallet}'} mobile apps are distributed via{' '}
    ...
    <p>
      We enable the user to unlock the {'XDC Safe{Wallet}'} mobile app via biometrics information (touch ID or face ID).
    ...
    <p>
      ...
      different decentralized applications and our app and to enhance your experience with {`XDC Safe{Wallet}`}. For
